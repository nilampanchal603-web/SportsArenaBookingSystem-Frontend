...
import { FiHome, FiUsers, FiMapPin, FiMessageSquare, FiFileText, FiLogOut, FiBell, FiUser } from 'react-icons/fi'
...
export const AdminNavbar = () => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/admin/admindata', icon: <FiHome className="text-xl" /> },
    { name: 'Manage Users', path: '/admin/users', icon: <FiUsers className="text-xl" /> },
    { name: 'Manage Arenas', path: '/admin/arenas', icon: <FiMapPin className="text-xl" /> },
    { name: 'Feedback', path: '/admin/feedback', icon: <FiMessageSquare className="text-xl" /> },
    { name: 'Reports', path: '/admin/reports', icon: <FiFileText className="text-xl" /> },
  ];
      ...
      <div className="w-64 bg-[#0F172A] text-white flex flex-col fixed h-full shadow-xl z-20 transition-all duration-300">
        <div className="p-6 border-b border-[#1F2937]">
          <h1 className="text-2xl font-bold text-white tracking-wide">
            ...
            <span className="block text-xs font-normal text-[#6B7280] mt-1 uppercase tracking-widest">Admin Panel</span>
          </h1>
        </div>
        ...
        <div className="p-4 border-t border-[#1F2937]">
          <button 
            ...
            className="flex items-center gap-3 w-full px-4 py-3 text-red-400 hover:bg-[#1F2937] hover:text-red-300 rounded-xl transition-all duration-200"
          >
        ...
        <header className="bg-white border-b border-[#E5E7EB] h-16 flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm font-medium text-[#1F2937] hidden md:block">Administrator</span>
            </div>
          </div>
        </header>
